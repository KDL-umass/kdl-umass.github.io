...
<!-- Style sheet for HTML version of RPC documentation     -->
<!-- ====================================================== -->
...
<xsl:import href="/usr/local/sgml/docbook-xsl-1.73.2/html/chunk.xsl"/>

<!-- Load common style sheet definitions -->
<xsl:include href="rpc-common.xsl"/>
...
<!-- now passed in from genrpcdoc.sh script
  <xsl:param name="base.dir" select="'HTML/'"/>
-->
<xsl:param name="toc.max.depth">2</xsl:param>
<xsl:param name="preferred.mediaobject.role" select="'html'"></xsl:param>
<xsl:param name="html.stylesheet" select="'kdldoc.css'"></xsl:param>
<xsl:param name="variablelist.as.table" select="1"></xsl:param>

<!-- ====================================================== -->
<!-- RPC parameters -->

<!-- Default value is 'doc/HTML'; can be changed by genrpcdoc.sh
     script -->
<xsl:param name="rpc.destination" select="'doc/HTML'"></xsl:param>
...
<!-- Some comments about xref styles:
     ...
     @ Only include gentext items in rpc-fo.xsl and rpc-html.xsl
       when they differ for HTML and PDF, otherwise  place them in
       rpc-common.xsl.
     @ Place default templates (no xrefstyle) in rpc-common.xsl.
-->

<xsl:param name="rpchtml.l10n.xml" select="document('')"/> 
...
<xsl:param name="local.l10n.merged">
  <l:i18n xmlns:l="http://docbook.sourceforge.net/xmlns/l10n/1.0">
    <l:l10n language="en">
      <xsl:copy-of
           select="$rpchtml.l10n.xml//l:i18n/l:l10n[@language='en']/*"/>
      <xsl:copy-of
...
<xsl:template name="system.head.content">
  <xsl:param name="node" select="."/>
      ...
      <xsl:text> Part of the KDL Relational PC package (see LICENSE for
