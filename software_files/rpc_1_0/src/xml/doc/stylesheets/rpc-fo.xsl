...
<!-- ====================================================== -->
<!-- Style sheet for PDF version of RPC documentation       -->
<!-- ====================================================== -->
...
<xsl:import href="/usr/local/sgml/docbook-xsl-1.73.2/fo/docbook.xsl"/>
...
<!-- Default value is 'doc'; can be changed by genrpcdoc.sh
     script -->
<xsl:param name="rpc.destination" select="doc"></xsl:param>
...
<xsl:param name="rpcfo.l10n.xml" select="document('')"/> 
...
<xsl:param name="local.l10n.merged">
  <l:i18n xmlns:l="http://docbook.sourceforge.net/xmlns/l10n/1.0">
    <l:l10n language="en">
      <xsl:copy-of
           select="$rpcfo.l10n.xml//l:i18n/l:l10n[@language='en']/*"/>
      <xsl:copy-of
           select="$rpccommon.l10n.xml//l:i18n/l:l10n[@language='en']/*"/>
    </l:l10n>
  </l:i18n>
</xsl:param>
...
<!-- Changed from default of 1.25in for double-sided; 1.0 otherwise -->
...
<!-- This template adds a pagebreak before a <section> (As opposed to
     <sect1>, <sect2>, etc.) that's at level 1, inserting a page break between
     individual recipes.
-->
...
<!-- Reduced spacing and changed keep-together.within-column to "auto"
     instead of "always" to allow examples to break across pages 
     (needed for FOP 0.95) -->
...
<!-- changed spacing from 0.4, 0.2, 0.6 -->
...
to the list.block.spacing attribute set aligns the list item number
correctly, but does not adjust for inline items, such as icons/buttons
or even for larger graphics in the middle of a procedure step. Also
wrecks havoc with admonition spacing.
-->
...
<xsl:attribute-set name="keeptogether.properties">
...
<!-- KDL 10/08: Updated to change "keep-together" to        -->
<!-- "keep-together.within-column" to enable line wrapping  -->
<!-- within a cell for FOP 0.95.                            -->
...
<!-- Used when setting role="edcomment" in <phrase> elements.
     The edited template for <phrase> is in rpc-common.xsl -->
