...
public class PropensityScoreQuantilesGreedy extends SkeletonFinder {

    protected static Logger log = Logger.getLogger(PropensityScoreQuantilesGreedy.class);
    ...
    public PropensityScoreQuantilesGreedy(Instances trainData) {
        this(trainData, trainData, new ThresholdModule());
    }

    public PropensityScoreQuantilesGreedy(Instances trainData, Instances poolData) {
        this(trainData, poolData, new ThresholdModule());
    }

    public PropensityScoreQuantilesGreedy(Instances instances, Instances poolInstances, ThresholdModule module) {
        super(instances);
        threshModule = module;
